...
with left:
    ...
    with col_btn:
        run_btn = st.button("Run Simulation", use_container_width=True, key="run_simulation_dashboard")
...
with input_col2:
    ...
    run_btn = st.button("Run Simulation", use_container_width=True, key="run_simulation_input")
